...
export class EventHandlerUtil {
    ...
    private static setEventMetasByNameAndHandlerId( 
        name: string,
        handlerId: string,
        meta: EventMeta
    ): void {
    ...
    private static setFiredByNameAndHandlerId(
        ...
        const meta = EventHandlerUtil.getEventMetaByHandlerId(name, handlerId);
        if(!meta) {
            return;
        }

        meta.fired = fired;
        EventHandlerUtil.setEventMetasByNameAndHandlerId(name, handlerId, meta);
    }
