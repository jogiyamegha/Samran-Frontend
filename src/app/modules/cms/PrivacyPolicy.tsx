...
const PrivacyPolicy = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        const apiService = new APICallService(CMS.PRIVACY_POLICY);
                ...
                >
                    <Row className="align-items-center">
                        <Col
                            ...
                            md={6}
                        >
                            <h1 className="fs-22 fw-bolder">Privacy Policy</h1>
                        </Col>
                    </Row>
                </Col>
                {fetchLoading ? (
